...
class EditCropEvent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            date: "2016-05-15",
              ...
              >
                ...
                <View style={{ flex: 7 }}>
                    ...
                    >
                      ...
                      >
                        <Picker>
                          <Picker.Item label="Pending" value="sp" />
                          ...
                          />
                                        ...
                                        <View style={{ marginTop: 15 }}>
                                            ...
                                            <TextInput
                                                onFocus={this.onFocus}
                                                autoFocus={false}
                                                placeholder="Should need 10 Workers"
