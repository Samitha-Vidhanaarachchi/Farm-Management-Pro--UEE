...
export default class NewFieldView extends Component {
  constructor(props) {
    super(props);
                        ...
                        >
                            ...
                            >
                                <TouchableOpacity
                                    ...
                                    onPress={() => {
                                        this.props.navigation.navigate("AddCropFieldDrawer");
                                    }}
                                >
                    ...
                    >
                        <View style={{ flex: 1 }}>
                            ...
                            >
                                <TouchableOpacity
                                    onPress={() => {
                                        this.props.navigation.navigate("SearchPaddockDrawer");
                                    }}
                                >
                                    <View
                                        style={{
                      ...
                      >
                        ...
                        >
                          <View style={{ flexDirection: "row" }}>
                            ...
                            <Text style={{ fontWeight: "bold" }}> 22-05-2020</Text>
                          </View>
                        </View>
                      </View>
                      ...
                      <View>
                        <Text style={{ color: "white" }}>X</Text>
                                ...
                                >
                                    <TouchableOpacity
                                        onPress={() => {
                                            this.props.navigation.navigate("SortPaddockDrawer");
                                        }}
                                        style={{
                                            ...styles.button,
                                            justifyContent: "center",
                                ...
                                >
                                    <View>
                                        <TouchableOpacity
                                            ...
                                            onPress={() => {
                                                this.props.navigation.navigate("EditPaddockDrawer");
                                            }}
                                        >
                                            <FontAwesome5
                                                name="pen"
                                ...
                                >
                                    <TouchableOpacity onPress={this.manageView}>
                                        ...
                                        >
                                            <View>
                                                <Image
                                                    source={require("../../assets/paddocks.jpg")}
                                                    style={{ height: 130, width: 130, borderRadius: 100 }}
                                                />
                                            </View>
                                        </View>
