                ...
                <View style={{ flex: 3, backgroundColor: "#fffffff" }}>
                  <View style={{ margin: 10, marginTop: 25 }}>
                    ...
                    <View style={{ marginTop: 15 }}>
                      ...
                      >
                        <Picker>
                          <Picker.Item label="Finished" value="sp" />
                          <Picker.Item label="In progress" value="fp" />
                          <Picker.Item label="Pending" value="afp" />
                        </Picker>
                      </View>
                    </View>
