...
class AddAnimalView extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      modalState: false,
      image:
        "https://watchandlearn.scholastic.com/content/dam/classroom-magazines/watchandlearn/videos/animals-and-plants/baby-animals-and-life-cycles/roosters-hens-and-chicks/english/wall-2018-roostershensandchicksmp4.transform/content-tile-large/image.png",
    };
  }
                  ...
                  <View style={{ margin: 10, marginTop: 25 }}>
                    ...
                    <View style={{ marginTop: 15 }}>
                      ...
                      <TextInput
                        onFocus={this.onFocus}
                        autoFocus={false}
                        placeholder="Alpha male rooster"
